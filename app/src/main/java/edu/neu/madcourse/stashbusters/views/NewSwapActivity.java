...
import edu.neu.madcourse.stashbusters.presenters.NewSwapPresenter;

public class NewSwapActivity extends AppCompatActivity implements NewSwapContract.MvpView {
    private RadioGroup materialGroup;
    private int clickedMaterial;

    private NewSwapPresenter mPresenter;

    private ImageButton imageButton;
    private EditText title, description, desiredMaterial;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new NewSwapPresenter(this);

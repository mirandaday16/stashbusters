...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.ViewHolder>{
    ...
    public FeedRecyclerAdapter(ArrayList<String> mImages, ArrayList<String> mUserNames, ArrayList<String> mHeadlines, ArrayList<String> mNumlikes, Context mContext) {
